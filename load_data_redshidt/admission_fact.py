...
from common.read_from_rds import *
...
#read  student table data from CDM(rds)
df_student = read_from_rds("student")

#read admission table data from CDM(rds)
df_admission = read_from_rds("admission")
df_admission1= df_admission.dropDuplicates(['AdmissionId'])
df = df_student.join(df_admission1, df_student.StudentId == df_admission1.StudentId, how="inner")
df.show(10)
...
print(df1.count())
# write to redshift admission fact table
